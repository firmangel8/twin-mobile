...
import imgLogo from '../../images/deliver-logo.png'
...
export default class AuthScreen extends Component {
  ...
  static propTypes = {
    ...
    // prepareRouter: PropTypes.func.isRequired,
  ...
  render () {
    console.log(this.props.prepareRouter)
      ...
      <View style={styles.container}>
        ...
        >
          ...
          {(visibleForm === 'LOGIN') && (
            <LoginForm
              ref={(ref) => this.formRef = ref}
              prepareRouter={this.props.prepareRouter}
